  ...
  return (
    <>
      ...
      <div className="premium-package">
        ...
        <button className="basicPurschase">Purschase </button>
      </div>
      <div className="premium-package">
        <h2>Standard Package</h2>
        <p className="price">$19.99/month</p>
        <button style={{marginLeft:'20%'}} class="standardPurschase"></button>
      </div>
      <div className="premium-package">
        <h2>Premium Package</h2>
        <p className="price">$29.99/month</p>
        <button style={{marginLeft:'10%'}} class="premiumPurschase">
